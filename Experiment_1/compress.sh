...
#   feature/dsae_pbhl_v2_all_speaker.npz (compress mcep_all_speaker.npz and speaker.npz)
...
python src/DSAE-PBHL/DSAE_PBHL_v2_train.py --train_data feature/mcep_all_speaker.npz --speaker_id feature/speaker.npz  --output_file feature/dsae_pbhl_v2_all_speaker.npz --structure ${DSAE_STRUCTURE} --pb_structure ${DSAE_PBHL_STRUCTURE}
