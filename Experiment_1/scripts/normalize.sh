...
python src/Normalize/uniform_normalize.py \
  --source_file feature/concat_mfcc_all_speaker_20msec.npz \
  --output_file feature/uninorm_concat_mfcc_all_speaker_20msec.npz \
  --min_value -1.0 \
  --max_value  1.0
...
python src/Normalize/uniform_normalize.py \
  --source_file feature/mfcc_speaker_H_20msec.npz \
  --output_file feature/uninorm_mfcc_speaker_H_20msec.npz \
  --min_value -1.0 \
  --max_value  1.0

python src/Normalize/uniform_normalize.py \
  --source_file feature/mfcc_speaker_K_20msec.npz \
  --output_file feature/uninorm_mfcc_speaker_K_20msec.npz \
  --min_value -1.0 \
  --max_value  1.0

python src/Normalize/uniform_normalize.py \
  --source_file feature/mfcc_speaker_M_20msec.npz \
  --output_file feature/uninorm_mfcc_speaker_M_20msec.npz \
  --min_value -1.0 \
  --max_value  1.0

python src/Normalize/uniform_normalize.py \
  --source_file feature/mfcc_speaker_N_20msec.npz \
  --output_file feature/uninorm_mfcc_speaker_N_20msec.npz \
  --min_value -1.0 \
  --max_value  1.0
...
python src/Normalize/gaussian_normalize_with_f0.py \
  ...
  --output_file feature/gaunorm_with_f0_spkind_mcep_all_speaker_5msec.npz \
...
python src/Extractor/pickup.py \
  --source_file feature/gaunorm_with_f0_spkind_mcep_all_speaker_5msec.npz \
  --output_file feature/gaunorm_mcep_speaker_H_5msec.npz \
  --keyword speaker_H

python src/Extractor/pickup.py \
  --source_file feature/gaunorm_with_f0_spkind_mcep_all_speaker_5msec.npz \
  --output_file feature/gaunorm_mcep_speaker_K_5msec.npz \
  --keyword speaker_K

python src/Extractor/pickup.py \
  --source_file feature/gaunorm_with_f0_spkind_mcep_all_speaker_5msec.npz \
  --output_file feature/gaunorm_mcep_speaker_M_5msec.npz \
  --keyword speaker_M

python src/Extractor/pickup.py \
  --source_file feature/gaunorm_with_f0_spkind_mcep_all_speaker_5msec.npz \
  --output_file feature/gaunorm_mcep_speaker_N_5msec.npz \
  --keyword speaker_N
