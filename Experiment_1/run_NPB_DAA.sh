...
sh src/NPB-DAA/watchdog_runner.sh -t feature/sgvc_new_all_speaker.npz -p feature/phn.npz -w feature/wrd.npz -l segmentation_result/sgvc_new_all_speaker
...
python src/NPB-DAA/unroll_default_config.py --default_config default_configs/mcep_defaults.config
sh src/NPB-DAA/watchdog_runner.sh -t feature/norm_all_speaker.npz -p feature/phn.npz -w feature/wrd.npz -l segmentation_result/norm_all_speaker
sh src/NPB-DAA/watchdog_runner.sh -t feature/norm_spkind_all_speaker.npz -p feature/phn.npz -w feature/wrd.npz -l segmentation_result/norm_spkind_all_speaker
sh src/NPB-DAA/watchdog_runner.sh -t feature/norm_speaker_H.npz -p feature/phn.npz -w feature/wrd.npz -l segmentation_result/norm_speaker_H
sh src/NPB-DAA/watchdog_runner.sh -t feature/norm_speaker_K.npz -p feature/phn.npz -w feature/wrd.npz -l segmentation_result/norm_speaker_K
sh src/NPB-DAA/watchdog_runner.sh -t feature/norm_speaker_M.npz -p feature/phn.npz -w feature/wrd.npz -l segmentation_result/norm_speaker_M
sh src/NPB-DAA/watchdog_runner.sh -t feature/norm_speaker_N.npz -p feature/phn.npz -w feature/wrd.npz -l segmentation_result/norm_speaker_N
