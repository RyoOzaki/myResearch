...
from DSAE_PBHL import AE, SAE, SAE_PBHL, SAE_PBHL_v2
from DSAE_PBHL import DSAE, DSAE_PBHL, DSAE_PBHL_v2
...
builder.stack(SAE_PBHL_v2, structure[-1], pb_hidden_dim=pb_structure[1])
